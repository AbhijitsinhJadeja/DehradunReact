        ...
        return (
            <div>
                ...
                <div className=" navbar-fixed-top" style={{ borderRadius: "0px", backgroundColor: "transparent", borderColor: "transparent", color: "white", textAlign:"right",float:"right", fontWeight:"500" }}>
                    <nav className="navbar navbar-expand-lg " style={{ borderRadius: "0px" }}>
                        ...
                        <div className="justify-content-end collapse navbar-collapse" id="navbarNavAltMarkup" style={{ borderRadius: "0px", marginLeft:"75%",fontWeight:"700",fontSize:"18px" }}>
                            <div className="navbar-nav">
                                ...
                                <div id="NavForHome" className="navbar-nav">
                                    <Link class="nav-item nav-link "  style={{color:"white"}} to="/"><i>HOME</i>  </Link>
                                    <Link class="nav-item nav-link " style={{ color: "white" }} to="/SignIn"> <i>SIGN IN</i> </Link>
                                    <Link class="nav-item nav-link" style={{ color: "white" }} to="/About"> <i>ABOUT</i> </Link>
                                    <a className="nav-item nav-link btn btn-success " href="Home/Citygis">CITY GIS</a>
                                </div>
                            </div>
                        </div >
                    </nav >
                    ...
                    <div id="carousel-example-generic" className="carousel slide " data-ride="carousel">
                        ...
                        <div className="carousel-inner" role="listbox">
                            <div className="item active">
                                ...
                                <div className="carousel-caption" style={{marginBottom:"220px"}}>
                            ...
                            <div className="item">
                                ...
                                <div className="carousel-caption" style={{ marginBottom: "100px" }}>
                        ...
                        <table>
                            ...
                            <tr >
                                <td >
                                    ...
                                    <Link to="Signup" style={{ color: "white", backgroundColor: "black", textDecoration: "none", padding: "6% 30%", fontWeight: "bold", marginLeft: "0%", borderRadius: "50px" }}>SIGN UP</Link>
                                </td>
                            </tr>
                        </table>
                    </form>
        ...
        return (
            <div className="example" id="b">
                ...
                <nav id="main1"> {/*mbot*/}
                    ...
                    <ul >
                        <li ><a id="imgNav" style={{ cursor: "pointer", fontSize: "16px" }}><i className="fas fa-globe-asia"></i>&nbsp;Image</a></li>
                        <li><a id="bookmamrkNav" style={{ cursor: "pointer", fontSize: "16px" }}><i className="fas fa-bookmark"></i>&nbsp;Bookmark</a></li>
                        <li><a id="cNav" style={{ cursor: "pointer", fontSize: "16px" }}><i className="fas fa-map-marked-alt" ></i>&nbsp;Coordinates</a></li>
                        <li><a id="identifyNav" style={{ cursor: "pointer", fontSize: "16px" }}><i className="fas fa-map-marked-alt" ></i>&nbsp;Identify</a></li>
                        <li><a id="preDefNav" style={{ cursor: "pointer", fontSize: "16px" }} ><i className="fas fa-question-circle"></i>&nbsp;Query</a></li>
                        <li><a id="AdvanceSearch" style={{ cursor: "pointer", fontSize: "16px" }} ><i className="fas fa-chart-area"></i>&nbsp;AdSearch</a></li>
                        <li><a id="logoutNav" style={{ cursor: "pointer", fontSize: "16px" }} ><i className="fas fa-sign-out-alt"></i>&nbsp;Logout</a></li>
            ...
            &ensp;&ensp;&ensp;&ensp;<input type="checkbox" id="bMuniciple" />Boundary Municiple<br></br>
                ...
                <div id="uparrowbtn" style={{ zIndex: "988" }}>
                    ...
                    <div style={{ border: "3px solid #0082e6" }} id="btm">
                        ...
                        <button className="btmbtn" id="stopBlinkNav" style={{ display: "none" }}><i className="fas fa-unlink"></i></button>
                ...
                <dialog id="dialog1" style={{ top: "35%", padding: "0", width: "500px", height: "305px", zIndex: "7" }}>
